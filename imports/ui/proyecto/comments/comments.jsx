            ...
            <div>
                ...
                {Meteor.user()
                    ? <div>
                            <div className="col-md-12">
                                <h4>
                                    Give a constructive review!</h4>
                            </div>
                            <div className="row">
                                <div className="col-md-10 offset-md-2">
                                    {this.props.alert && <div className="alert alert-danger" role="alert">
                            ...
                            <div className="col-md-12">
                                ...
                                <form onSubmit={this.cleanComment.bind(this)}>
                                    <textarea aria-label="Write a constructive review" className="form-control" rows="3" value={this.state.curComment} type="text" onChange={(event) => this.setState({curComment: event.target.value})}/>
                                    <br></br>
